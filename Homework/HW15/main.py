from Homework.HW15.order import Order
from Homework.HW15.item import Item
from Homework.HW15.customer import Customer
...
# Orders
order_0001 = Order()
order_0001.order_id = customer_001.orders[0]
order_0001.name = customer_001.name
order_0001.shipping_address = customer_001.address
order_0001.total = 220.08
order_0001.items = {item_02.name: 1, item_04.name: 2}
order_0001.date = "01/10/2020"
order_0001.status = "Shipped"

order_0002 = Order()
order_0002.order_id = customer_002.orders[2]
order_0002.name = customer_002.name
order_0002.shipping_address = customer_002.address
order_0002.total = 136.69
order_0002.items = {item_03.name: 1, item_05.name: 2}
order_0002.date = "01/03/2020"
order_0002.status = "Delivered"

order_0003 = Order()
order_0003.order_id = customer_003.orders[1]
order_0003.name = customer_003.name
order_0003.shipping_address = customer_003.address
order_0003.total = 456.69
order_0003.items = {item_01.name: 1, item_02.name: 2}
